return {
	cordoom1 = {
		...
		corpse = "dead",
		damagemodifier = 0.2,
		description = "Heavy Mainline Energy Defence",
		...
		weapondefs = {
			...
			corsumo_weapon10 = {
				...
				damage = {
					default = 110, -- from 350, total 550
					subs = 5,
				},
				tracks = false,
			},
