	...
	talon_solarwind = {
		...
		weapondefs = {
			barrage = {
				...
				avoidfeature = false,
				burnblow = true,
				burst = 8, -- total 32 projectiles
				projectiles = 4, 
				burstrate = 0.5, -- fires in bursts of 4 every 0.5 seconds
				...
				name = "Barrage",
				proximitypriority = -1,
				range = 2600, -- from 2400
				reloadtime = 10, -- halved reload time 
				smoketrail = true,
				...
				weaponvelocity = 900,
				wobble = 600, -- from 1200, more accurate
				damage = {
					default = 2500,
					subs = 5,
				},
